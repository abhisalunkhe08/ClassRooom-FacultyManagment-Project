...
public class ClassScheduleController {
		...
		@PutMapping("/{id}")
		public ClassSchedule updateClassSchedule(@PathVariable int id, @RequestBody ClassSchedule classScheduleDetails) {
		...
		@DeleteMapping("/{id}")
		public void deleteClassSchedule(@PathVariable int id) {
